...
class DeploymentDeletionMarker(AirplaneTask):
    ...
    def main(self, params):
        ...
        deprov_info = alter_deployment_file(
...
Time when DNS will be removed (no more access to their instance via the browser): {deprov_info.dns_removal_time}
Time when the instance will be torn down (an unrecoverable operation): {deprov_info.teardown_time}
