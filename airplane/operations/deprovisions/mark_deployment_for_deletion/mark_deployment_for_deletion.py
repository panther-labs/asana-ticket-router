...
class DeploymentDeletionMarker(AirplaneTask):
    ...
    def main(self, params):
        ...
        deprov_info, _ = alter_deployment_file(deployments_repo=repo,
                                               ap_params=params,
                                               alter_callable=lambda filepath: self.add_deprovisioning_tags(
                                                   filepath, ap_params.hours_before_dns_removal, ap_params.
                                                   hours_before_teardown, ap_params.aws_account_id, ap_params.org_name),
