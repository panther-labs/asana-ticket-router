...
def get_org_role_arn(organization: str) -> str:
...
def move_account_to_ou(organization: str,
                       aws_account_id: str,
                       fairytale_name: str,
                       target_ou_name: str,
                       test_run: bool) -> None:
    org_client = get_credentialed_client(service_name="organizations",
                                         arns=get_org_role_arn(organization),
...
def main(params: dict) -> None:
    move_account_to_ou(organization=params["organization"],
